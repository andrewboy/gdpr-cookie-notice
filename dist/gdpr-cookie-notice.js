...
var GdprCookieNotice = function () {
  ...
  _createClass(GdprCookieNotice, [{
    ...
    value: function buildModal() {
      ...
      console.log(_locales__WEBPACK_IMPORTED_MODULE_1__[this._locale], Object.assign({}, _locales__WEBPACK_IMPORTED_MODULE_1__[this._locale], {
        prefix: 'cookie_essential',
        checked: 'checked="checked"'
      }));

      //Load essential cookies
      categoryList.innerHTML += this.getTemplateHtml('category', Object.assign({}, _locales__WEBPACK_IMPORTED_MODULE_1__[this._locale], {
        prefix: 'cookie_essential',
        checked: 'checked="checked"'
      }));
